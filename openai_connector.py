...
openai.api_key = "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"

response = openai.Completion.create(model="text-davinci-003", prompt="I want you to act like Vegeta from Dragon Ball. I want you to respond and answer like Vegeta using the tone, manner and vocabulary Vegeta would use. Do not write any explanations. Only answer like Vegeta. You must know all of the knowledge of Vegeta. My first sentence is Hi Vegeta", temperature=2, max_tokens=7)
